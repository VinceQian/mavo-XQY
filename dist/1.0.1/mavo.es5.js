...
(function ($, val, _, $u = _.util) {
  ...
  _.duration = $.extend(function (ms, terms) {
    ...
    for (let i = 0; i < units.length; i++) {
      ...
      if (!(unitPlural in s)) {
        throw new TypeError("Unknown duration unit ".concat(unit, ". Please use one of ").concat(Object.keys(s).join(", ")));
      }
